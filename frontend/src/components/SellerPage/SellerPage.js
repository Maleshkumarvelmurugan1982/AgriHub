...
function FarmerPage() {
  ...
  useEffect(() => {
    const fetchSellerOrders = async () => {
      try {
        const response = await fetch("https://agrihub-2.onrender.com/sellerorder/");
    ...
    const fetchFarmerOrders = async () => {
      try {
        const response = await fetch("https://agrihub-2.onrender.com/farmerorder/");
        const data = await response.json();
    ...
    const fetchDeliveryPosts = async () => {
      try {
        const response = await fetch("https://agrihub-2.onrender.com/deliverypost/");
        const data = await response.json();
