  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        switch (catogery) {
          case "Veg":
            url = "https://agrihub-2.onrender.com/product/Vegetable";
            break;
          case "Fruit":
            url = "https://agrihub-2.onrender.com/product/fruit";
            break;
          case "Grain":
            url = "https://agrihub-2.onrender.com/product/Grain";
            break;
          case "Spices":
            url = "https://agrihub-2.onrender.com/product/spices";
            break;
          case "Other":
            url = "https://agrihub-2.onrender.com/product/other";
            break;
          default:
            break;
        }
      ...
      try {
        const response_add = await fetch("https://agrihub-2.onrender.com/product/add");
