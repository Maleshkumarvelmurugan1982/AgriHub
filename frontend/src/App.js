...
import GovernmentPage from './components/GovernmentPage/GovernmentPage';
...
import RegSellerPage from './components/AfterRegistered/RegSellerPage/RegSellerPage';
import RegDeliverymanPage from './components/AfterRegistered/RegDeliverymanPage/RegDeliverymanPage';
  ...
  return (
    ...
    >
      ...
      <Routes>
        ...
        <Route path='/regseller' element={<RegSellerPage />} />
        <Route path='/regdeliveryman' element={<RegDeliverymanPage />} />
